...
> et listent les types de missions.
...
- Applications mobiles iOS & Android (Flutter, React Native) publiées sur les stores
- Boutiques e-commerce & modules PrestaShop (multiboutique, paiements, CRM)
- Plateformes SaaS & applications métier (tableaux de bord, espaces clients, back-offices)
- API robustes & intégrations (Mobile Money, WhatsApp, SMS, services tiers)
...
- iOS & Android mobile apps (Flutter, React Native), published to the stores
- E-commerce stores & PrestaShop modules (multistore, payments, CRM)
- SaaS platforms & business apps (dashboards, client portals, back-offices)
- Robust APIs & integrations (Mobile Money, WhatsApp, SMS, third-party services)
